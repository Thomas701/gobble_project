...
int initialiseDebutProgramme(SDL_Window ** window, SDL_Texture ** textureMenu, SDL_Texture *** textureBackground, SDL_Texture ** textureMapVideB, SDL_Texture ** textureMapVideR, SDL_Surface ** icones, SDL_Renderer ** renderer); //initialise le début du programme graphique
