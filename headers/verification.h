...
int existPionInMap(char ** map2D, char c); // Vérifie si le joueur possède au moins un piont dans la map qu'il peut déplacer
int existPionInStack(char ** stack, int num, int i); //Vérifie si il existe un piont de taille i dans la pile numéro "num"
