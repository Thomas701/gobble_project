...
int loadTextureOptionMenu(SDL_Renderer ** renderer, SDL_Texture *** ptextureTableauOptionMenu) {
  SDL_Texture ** textureTableauOptionMenu = (SDL_Texture **) malloc(sizeof(SDL_Texture *)*5); // alloue le tableau de texture
  ...
  for (int i = 0; i < 5; i++) { // seulement 5 options dans le menu principal
    char nom[30];
